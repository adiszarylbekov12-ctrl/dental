...
<Reveal className="max-w-[560px]">
          ...
          <h2 className="mb-4 text-pretty font-display text-[clamp(1.65rem,2.6vw+1rem,2.75rem)] leading-[1.15] font-bold text-ink">
  {dict.about.title}
</h2>
        ...
        <Reveal className="flex flex-col gap-5" delay={0.1}>
          ...
          <div className="grid grid-cols-2 gap-4">
            {dict.about.stats.map((stat) => (
              <div
                key={stat.label}
                className="rounded-card border border-ink/8 bg-white px-4 py-5 sm:px-5.5 sm:py-6.5 shadow-card-sm transition-all duration-400 hover:-translate-y-1 hover:shadow-card-md"
              >
                <div className="mb-2 font-display text-[clamp(1.4rem,5vw+0.5rem,2.4rem)] font-extrabold leading-none text-primary-dark">
