        ...
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-[1.4fr_1fr_1fr_1.1fr] md:gap-8">
          ...
          <div>
            <Image
              ...
              className="mb-4 h-10 w-auto brightness-0 invert md:h-12"
            />

            <p className="max-w-[260px] text-[13.5px] leading-relaxed text-white/55">
              {dict.footer.tagline}
            </p>
          ...
          <div>
            <h4 className="mb-4 text-[13px] font-bold uppercase tracking-wide text-white/90">
          ...
          {/* <div>
            ...
            <ul className="flex flex-col gap-2.75">
              {[
                ...
                dict.services.items[4],
                dict.services.items[5],
                dict.services.items[7],
              ].map((s) => (
                <li key={s.key}>
                  <Link
